...
namespace GreenGardenClient.Controllers.AdminController
{
    public class EventManagementController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var events = GetDataFromApi<List<EventVM>>("http://103.75.186.149:5000/api/Event/GetAllEvents");
        ...
        public async Task<IActionResult> CreateEvent(EventVM model)
        {
            ...
            string apiUrl = "http://103.75.186.149:5000/api/Event/AddEvent";
        ...
        public async Task<IActionResult> UpdateEvent(int id)
        {
            ...
            var eventItem = GetDataFromApi<UpdateEvent>($"http://103.75.186.149:5000/api/Event/GetEventById?eventId={id}");
            var userRole = HttpContext.Session.GetInt32("RoleId");
        ...
        public async Task<IActionResult> UpdateEvent(UpdateEvent model, IFormFile PictureUrl, string CurrentPictureUrl)
        {
            ...
            string apiUrl = "http://103.75.186.149:5000/api/Event/UpdateEvent";
            try
            {
        ...
        public async Task<IActionResult> DeleteEvent(int id)
        {
            ...
            string apiUrl = $"http://103.75.186.149:5000/api/Event/DeleteEvent/{id}";
