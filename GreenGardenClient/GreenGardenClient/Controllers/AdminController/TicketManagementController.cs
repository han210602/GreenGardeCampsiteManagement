...
namespace GreenGardenClient.Controllers.AdminController
{
    public class TicketManagementController : Controller
    {
        ...
        {
            var ticket = await GetDataFromApiAsync<List<TicketVM>>("http://103.75.186.149:5000/api/Ticket/GetAllTickets");
        ...
        public async Task<IActionResult> UpdateTicketDetail(int ticketId)
        {
            ...
            try
            {
                ...
                var campingCategories = await GetDataFromApiAsync<List<TicketCategoryVM>>("http://103.75.186.149:5000/api/Ticket/GetAllTicketCategories");
        ...
        public async Task<IActionResult> UpdateTicket(UpdateTicketVM model, IFormFile PictureUrl, string CurrentPictureUrl)
        {
            ...
            string apiUrl = "http://103.75.186.149:5000/api/Ticket/UpdateTicket";
            try
            {
        ...
        {
            string apiUrl = $"http://103.75.186.149:5000/api/Ticket/ChangeTicketStatus?ticketId={ticketId}";
        ...
        public async Task<IActionResult> CreateTicket(AddTicketVM model, IFormFile PictureUrl)
        {
            ...
            string apiUrl = "http://103.75.186.149:5000/api/Ticket/AddTicket";
