...
class Event extends React.Component {
  render() {
    return (
      <div className="event">
        <h1>Event-teambuilding</h1>
        <p>Khoảnh khắc tại Sông Quê Green Garden</p>
        <div className="card">      
              <EventData
           ...
           text="Tham gia hoạt động nhóm tại sông quê Green Garden mang lại trải nghiệm gần gũi thiên nhiên và gắn kết cộng đồng. Bạn sẽ cùng nhau tham gia các trò chơi dân gian truyền thống  để có thể  rèn luyện tinh thần đồng đội, tận hưởng không khí trong lành và tạo nên những kỷ niệm đáng nhớ cùng bạn bè."
            />
              <EventData
            ...
            text="Khi tham gia tổ chức tiệc ngoài trời tại sông quê Green Garden là cơ hội để tận hưởng không gian thiên nhiên thoáng đãng, với khung cảnh sông nước thanh bình. Bạn có thể cùng bạn bè, gia đình tổ chức tiệc nướng BBQ, cắm trại, và tham gia các hoạt động giải trí ngoài trời. Đây là nơi lý tưởng để thư giãn, gắn kết mọi người và tạo nên những khoảnh khắc đáng nhớ giữa khung cảnh thiên nhiên xanh mát."
            />
              <EventData
           ...
           text="Hòa mình với thiên nhiên tại sông quê Green Garden mang đến cảm giác yên bình và thư thái. Bạn sẽ được đắm mình trong khung cảnh xanh tươi của cỏ cây, dòng sông êm đềm và không khí trong lành. Đây là nơi lý tưởng để tạm rời xa nhịp sống hối hả, thư giãn và kết nối với thiên nhiên một cách trọn vẹn"
            />
