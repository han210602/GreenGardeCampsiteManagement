...
namespace DataAccess.DAO
{
    public class ComboDAO
    {
        ...
        public static List<ComboDTO> GetListCombo()
        {
            ...
            try
            {
                listProducts = _context.Combos.Select(f => new ComboDTO
                    {
                        ComboId = f.ComboId,
        ...
        public static List<ComboDTO> GetListCustomerCombo()
        {
            ...
            try
            {
                    ...
                    listProducts = _context.Combos.Where(s => s.Status == true).Select(f => new ComboDTO
                    {
                        ComboId = f.ComboId,
                        ComboName = f.ComboName,
                        Description = f.Description,
        ...
        public static void ChangeComboStatus(int comboId, ChangeComboStatus newStatus)
        {
            ...
            var foodAndDrink = _context.Combos.FirstOrDefault(f => f.ComboId == comboId);
        ...
        public static ComboDetail GetComboDetail(int id)
        {
            ...
            try
            {
                    ...
                    listProducts = _context.Combos.Include(t => t.ComboTicketDetails).ThenInclude(s => s.Ticket)
